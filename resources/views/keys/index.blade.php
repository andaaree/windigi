<!DOCTYPE html>
@extends('/admin/body')
@section('title', 'Stock Product Key - WDT (Windows Digital Tracker)')
@section('ext-css')
    <!-- Select2 -->
...
@section('container')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="display-4">Stock Product Key</h3>
                </div>
                <div class="col-sm-6">
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            return '<button data-id="' + data +
                                '" type="button" class="d-inline del-key btn btn-danger"><i class="fas fa-trash"></i></button>';
                        },
                        searchable: false,
                        orderable: false
                    }
